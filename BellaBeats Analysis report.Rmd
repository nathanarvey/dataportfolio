...
```{r viewing activity,echo=FALSE}
tibble(dailyActivity_merged)
```

*sleepDay_merged*
```{r viewing sleep,echo=FALSE}
tibble(sleepDay_merged)
```

*timeIntensities*
```{r viewing intensities,echo=FALSE}
...
```{r create realActivity,include=FALSE}
...
```{r cleaning dates,include=FALSE}
...
```{r creating sleep activity, include=FALSE}
...
```{r calories histogram, echo=FALSE}
ggplot(data = realActivity) +
...
```{r step and calorie scatterplot faceted,echo=FALSE}
ggplot(data=realActivity) +
...
```{r step and calorie scatterplot totals, echo=FALSE, message=FALSE}
ggplot(data=realActivity) +
  geom_point(mapping=aes(x=TotalSteps,y=Calories,color=NewId))+
...
```{r steps and sleep scatterplot, echo=FALSE, message = FALSE}
...
```{r sed and sleep scatterplot, echo=FALSE, message = FALSE}
ggplot(data = SleepActivity)+
...
```{r linreg for sed and sleep time, echo=FALSE}
...
```{r individual excercise, echo=FALSE}
...
```{r average intensity measure over time, echo=FALSE, message=FALSE}
ggplot(data=timeIntensities)+
